...
public class AjoutReservationController implements Initializable {
    ...
    private final reservation reservationToAdd = new reservation();
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
        btn_add_res.setOnAction(new EventHandler<ActionEvent>() {
            @Override
    ...
    @FXML
    private void ajouter_res() {
          if (tf_prix.getText().toString().equals("") || tf_poids.getText().toString().equals("")
            ...
            reservationToAdd.setPrix(Integer.valueOf(tf_prix.getText()));
            reservationToAdd.setPoids(Integer.valueOf(tf_poids.getText()));
            reservationToAdd.setVilleDepart(String.valueOf(tf_v_d.getText()));
            reservationToAdd.setVilleArrive(String.valueOf(tf_v_a.getText()));
            reservationToAdd.setDateReser(String.valueOf(tf_DR.getText()));


            rs.addReservation(reservationToAdd);
    ...
    private void AddImage(ActionEvent event) {
        ...
        reservationToAdd.setImage(selectedFile.getAbsoluteFile().getName());
