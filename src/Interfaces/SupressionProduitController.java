 ...
 * @author DELL
 */
public class SupressionProduitController implements Initializable {

    @FXML
    private TextField id_produit_sup;
    @FXML
    private Button btn_suppression_produit;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
             btn_suppression_produit.setOnAction(new EventHandler<ActionEvent>() {
            @Override
    ...
    private void suppressionP(){
      //produit C = tvCommentaire.getSelectionModel().getSelectedItem();
        ...
        if(id_produit_sup.getText().isEmpty()){
       ...
       // p.setId_produit(Integer.valueOf(id_produit_sup.getText()));
        ps.deleteProduit(Integer.valueOf(id_produit_sup.getText()));
