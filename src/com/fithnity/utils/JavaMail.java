...
public class JavaMail {
    ...
    public static void sendMail(String recepient,String reponse) throws MessagingException {
        ...
        String myEmailAccount = "allani.aziz01@gmail.com";
        String myEmailPassword = "dwasqqrygqnypxuc";
    ...
    private static Message prepareMessage(Session session, String myEmailAccount, String recepient,String reponse) {
        try {
            ...
            message.setSubject("FI_THNITY");
            message.setText(  "Votre reponse pour votre reclamation= "+ reponse);
            return message;
        } catch (Exception ex) {
