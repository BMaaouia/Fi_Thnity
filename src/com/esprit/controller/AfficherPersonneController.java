...
import com.esprit.dao.ReclamationDao;
...
//         });  
 ...
 //////// methode select users ///////
    ...
    Reclamation current = personsTable.getSelectionModel().getSelectedItem();
...
//            p.setId(Integer.parseInt(txt_id.getText()));
   ...
   @FXML
    private void rafraichir(ActionEvent event) throws IOException { 
		Parent root2 = FXMLLoader .load(getClass().getResource("/com/esprit/view/AfficherPersonne.fxml"));
    ...
    private void back(ActionEvent event) throws IOException { 
		Parent root3 = FXMLLoader .load(getClass().getResource("/com/esprit/view/Accueil.fxml"));
