...
public class DASHBOARDreservationController implements Initializable {
    ...
    @FXML
    private TableView<reservation> id_list;
    @FXML
    private TableColumn<reservation,Integer> id_prix;
    @FXML
    private TableColumn<reservation,Integer> id_poids;
    @FXML
    private TableColumn<reservation,String> id_v_a;
    @FXML
    private TableColumn<reservation,String> id_v_d;
    @FXML
    private TableColumn<reservation,Date> id_Date;
    @FXML
    private Button supp;
    @FXML
...
//             Refresh();
      ...
      prix_filed.setText(Integer.toString(current.getPrix()));
       ...
       current.setPrix(Integer.parseInt(prix_filed.getText()));
        ...
        Parent root2 = null;
            try {
                root2 = FXMLLoader .load(getClass().getResource("/GUI/DASHBOARDreservation.fxml"));
...
//    
   ...
   id_list2.setItems(FXCollections.observableArrayList(filteredList));
    ...
    private void back(ActionEvent event) throws IOException {
               Parent page1 = FXMLLoader.load(getClass().getResource("/GUI/ADDreservation.fxml"));
